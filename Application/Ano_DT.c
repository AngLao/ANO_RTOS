...
void ANO_DT_Send_Data(u8 *dataToSend , u8 length)
{
	...
	Drv_Uart3SendBuf(data_to_send, length);
#endif
}
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(imu_data.rol,imu_data.pit,imu_data.yaw,wcz_hei_fus.out,flag.flight_mode,flag.unlock_sta);	
	}	
///////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(sensor.Acc[X],sensor.Acc[Y],sensor.Acc[Z],sensor.Gyro[X],sensor.Gyro[Y],sensor.Gyro[Z],mag.val[X],mag.val[Y],mag.val[Z]);//  sensor.Gyro[X],sensor.Gyro[Y]
	}	
/////////////////////////////////////////////////////////////////////////////////////
